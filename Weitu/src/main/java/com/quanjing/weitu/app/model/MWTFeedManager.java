...
public class MWTFeedManager {
    ...
    public final static String kWTFeedIDIngenious = "3";
    public final static String kWTFeedIDMaster = "2";
    public final static String kWTFeedIDArt = "6";
    public final static String kWTFeedIDT = "7";
    ...
    private void setupDefaultFeeds() {
        ...
        feedInfo = new MWTFeedInfo(kWTFeedIDIngenious, "创意", "Ingenious");
        feed = new MWTFeed(feedInfo);
        registerFeed(feed);

        feedInfo = new MWTFeedInfo(kWTFeedIDMaster, "大师", "Master");
        feed = new MWTFeed(feedInfo);
        registerFeed(feed);

        feedInfo = new MWTFeedInfo(kWTFeedIDArt, "艺术", "Art");
        feed = new MWTFeed(feedInfo);
        registerFeed(feed);

        feedInfo = new MWTFeedInfo(kWTFeedIDT, "T台", "T");
        feed = new MWTFeed(feedInfo);
        registerFeed(feed);
    }
